...
public class MethodVoidDeclDerived2 extends MethodVoidDecl {

    private MethVoidName MethVoidName;
    private FormParams FormParams;
    private VarDeclList VarDeclList;

    public MethodVoidDeclDerived2 (MethVoidName MethVoidName, FormParams FormParams, VarDeclList VarDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethodVoidDeclDerived2(\n");

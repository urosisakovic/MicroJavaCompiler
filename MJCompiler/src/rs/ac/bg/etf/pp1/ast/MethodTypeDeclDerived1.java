...
public class MethodTypeDeclDerived1 extends MethodTypeDecl {
    ...
    public MethodTypeDeclDerived1 (MethTypeName MethTypeName, FormParams FormParams, VarDeclList VarDeclList, StatementList StatementList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethodTypeDeclDerived1(\n");

...
public class MethodVoidDeclDerived1 extends MethodVoidDecl {
    ...
    public MethodVoidDeclDerived1 (MethVoidName MethVoidName, FormParams FormParams, VarDeclList VarDeclList, StatementList StatementList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethodVoidDeclDerived1(\n");

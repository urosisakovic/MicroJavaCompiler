...
public class MethodVoidDeclDerived6 extends MethodVoidDecl {

    private MethVoidName MethVoidName;
    private VarDeclList VarDeclList;

    public MethodVoidDeclDerived6 (MethVoidName MethVoidName, VarDeclList VarDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethodVoidDeclDerived6(\n");

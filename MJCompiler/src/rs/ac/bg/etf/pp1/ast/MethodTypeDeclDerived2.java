...
public class MethodTypeDeclDerived2 extends MethodTypeDecl {

    private MethTypeName MethTypeName;
    private FormParams FormParams;
    private VarDeclList VarDeclList;

    public MethodTypeDeclDerived2 (MethTypeName MethTypeName, FormParams FormParams, VarDeclList VarDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethodTypeDeclDerived2(\n");
